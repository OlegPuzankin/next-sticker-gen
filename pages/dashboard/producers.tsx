...
export default function DashboardProducers() {
      ...
      unsubscribe = fbInstance.db.doc("_producers/data").onSnapshot((doc) => {
        ...
        for (const [key, value] of Object.entries(producers)) {
          data.push({
            name: value.name,
            id: key,
            producerFullData: value.producerFullData,
          })
        }
  ...
  async function deleteProducer(producerId: string) {
    ...
    if (confirmDelete) {
      await fbInstance.db
        .doc("_producers/data")
        .update({ [producerId]: firebase.firestore.FieldValue.delete() })
      formik.setValues({ newProducerName: "", newProducerFullData: "" })
    }
  }
        ...
        <form className="dashboard-form" onSubmit={formik.handleSubmit}>
          <div className="d-flex mb-2">
            <Input
              ...
              error={
                formik.touched.newProducerName && formik.errors.newProducerName
              }
          ...
          <div className="w-100">
            <TextArea
              ...
              error={
                formik.touched.newProducerFullData &&
                formik.errors.newProducerFullData
              }
